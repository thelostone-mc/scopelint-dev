...
fn test_check_proj1_all_findings() {
    ...
    let expected_findings = [
        ...
        "Invalid error name in ./src/Counter.sol on line 38: Error 'AnotherInvalidError' should be prefixed with 'Counter_'",
        "Invalid error name in ./src/Counter.sol on line 37: Error 'InvalidError' should be prefixed with 'Counter_'",
